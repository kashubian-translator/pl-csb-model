...
def use_model(config: dict, logger: Logger) -> None:
    ...
    translated_message = Translator(logger, model, tokenizer).translate(message, "pol_Latn", "por_Latn")
...
def evaluate_model(config: dict, logger: Logger) -> None:
    ...
    evaluator: ModelEvaluator = ModelEvaluator(logger, model, tokenizer)
